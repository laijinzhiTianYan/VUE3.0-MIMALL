                ...
                <div class="list" v-for = "(arr, i) in phoneList" :key = "i">
                  <div class="list-item" v-for = "(item ,j) in arr" :key = "j"><!-- 单个产品块 -->
                    ...
                    <div class="list-item-info">
                      ...
                      <p class="list-item-price">￥{{item.price}}<a href="" class="list-item-cart"></a></p><!-- 其实这里要用过滤器格式化传入值的 -->
...
export default {
  ...
  data () {
    return {
      ...
      phoneList:[//手机产品区的二维数组，其实也需要用对象来做一些数据引入
      ]
    }
  },
  mounted () {
              ...
              .list-item{//每个元素
                ...
                .list-item-info{
                  ...
                  .list-item-price{
                    ...
                    .list-item-cart{
                      outline: dashed .1px ;
                      @include bgImg(16,16,"/imgs/icon-cart-hover.png");//z注意传参时候，要看原函数需不需要带单位
